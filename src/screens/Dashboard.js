			...
			<View style={styles.container}>
				...
				>
					...
					>
						...
						<AppText style={styles.sortLabel}>Sort Item</AppText>
						<Modal
							animationType="fade"
							transparent={true}
